...
def check():
    ...
    if not ("Author : BD BOMBER" in file) or not ("GitHub : https://github.com/SHOHAN OFFICIAL " in file) or not ("BD BOMBER" in file) or not ("https://raw.githubusercontent.com/BDBOMBER/BD Bomber/main/more/.version" in file):
        ...
        print("\n\033[92m[\033[91m*\033[92m] Tool Link: \033[37mhttps://github.com/Toxic-hacker/BD-Bomber\n")
        sys.exit()
