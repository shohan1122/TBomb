...
def update():
    ...
    os.system("cd .. && rm -rf ToxicBomber && git clone https://github.com/shohan1122/BD-BOMBER > /dev/null 2>&1")
...
def logo():
    ...
    print("\033[94m│     \033[92m BD BOMBER        \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m shohan offical........   \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m  \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : SHOHAN OFFICAL                 \033[94m│".center(columns+15))
    ...
    print("│ \033[95mCoder  : Shohan offical              \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
